...
const ContactCard = () => {
  return (
    <div className="w-auto md:w-[50rem] xl:w-[70rem] min-h-[32rem]  text-white p-[1rem] md:p-[2rem]  sm:text-left text-center">
        ...
        <a href="https://x.com/kleprer2" target="_blank" className="cursor-default"><p className="mt-[3rem] sm:mt-[1rem]"><span className="cursor-pointer text-[1.5em] border-b-[3px] pb-[0.5rem] border-w-fit-content hover:opacity-[50%]">x.com</span></p></a>
