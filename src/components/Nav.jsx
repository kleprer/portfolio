...
const Nav = () => {
  ...
  return (
    <div className="bg-black w-screen h-fit pt-[0.5rem] pb-[1rem] sm:pr-[0.5rem] pr-[0] relative">
        <TbWorld onClick={() => handleLocaleChange(loc)} className="size-[3rem] relative left-[40%] 
        sm:left-[45%] md:left-[92%] md:fixed text-white w-fit hover:opacity-[50%] hover:cursor-pointer " />
    </div>
  )
}
