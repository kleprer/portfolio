...
const ProjectCard = (props) => {
  ...
  let pj = String(props.project.id);
  ...
  return (
    <div className="min-h-[28.5rem] w-auto xl:w-[70rem] h-fit  text-white p-[1rem] md:p-[2rem] bg-black">
        <div className="flex flex-col lg:flex-row items-center align-center gap-[2rem] md:pt-[2rem]">
            <img src={project.source} alt="project" className="max-h-[24rem] max-w-[25rem] m-0"/>
            <div className="w-auto  m-auto sm:m-0 md:m-auto text-center md:text-left ">
                ...
                <a href={project.href} target="_blank"><button className="mt-[2rem] md:w-fit sm:w-[316px] m-auto border-[2px] border-white p-[10px] hover:opacity-[50%]">{t(`projects.${pj}.ref`)}</button></a>
